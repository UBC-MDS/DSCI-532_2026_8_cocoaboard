...
| --- | ------------------------------- | -------------- | ----------------------------- |
| 1   | When I select a chocolate product I want to see the countries colored on a scale with sales totals so I can quickly see which countries have the most demand for that product. | ⚒️ In progress |                               |
